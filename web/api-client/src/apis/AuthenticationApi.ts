...
export class AuthenticationApi extends runtime.BaseAPI {
     ...
     */
    async createUserRaw(requestParameters: CreateUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponsesSimpleMessage>> {
     ...
     */
    async generateDeviceTokenRaw(requestParameters: GenerateDeviceTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: string; }>> {
        if (requestParameters['device'] == null) {
            throw new runtime.RequiredError(
                'device',
                'Required parameter "device" was null or undefined when calling generateDeviceToken().'
            );
        }
     ...
     * Generate Device Token
     */
    async generateDeviceToken(requestParameters: GenerateDeviceTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: string; }> {
     ...
     */
    async resendVerificationRaw(requestParameters: ResendVerificationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponsesSimpleMessage>> {
        if (requestParameters['resend'] == null) {
            throw new runtime.RequiredError(
                'resend',
                'Required parameter "resend" was null or undefined when calling resendVerification().'
            );
        }
     ...
     */
    async verifyRegistrationRaw(requestParameters: VerifyRegistrationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponsesLoginResponse>> {
        if (requestParameters['verification'] == null) {
            throw new runtime.RequiredError(
                'verification',
                'Required parameter "verification" was null or undefined when calling verifyRegistration().'
            );
        }
     ...
     * Verify user registration
     */
    async verifyRegistration(requestParameters: VerifyRegistrationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponsesLoginResponse> {
